...
class EfficientNet3D(nn.Module):
    ...
    def __init__(self, n_features, blocks_args=None, global_params=None, in_channels=3):
        super().__init__()
        ...
        self._fc = Output(out_channels + self.n_features, self._global_params.num_classes)
        # self._fc.__class__.__name__ = 'Output'
        self._swish = MemoryEfficientSwish()
    ...
    @classmethod
    def from_name(cls, model_name, n_features, override_params=None, in_channels=3):
        cls._check_model_name_is_valid(model_name)
        blocks_args, global_params = get_model_params(model_name, override_params)
        return cls(n_features, blocks_args, global_params, in_channels)
